...
import { communicationService, leadService } from "@/services";
    ...
    <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex items-center space-x-3">
                <Button variant="outline" icon="Download">Export Report
                                </Button>
                <Button icon="Plus">Quick Add
                                </Button>
            </div>
        </div>
        {/* Stats Cards */}
            ...
            <div className="lg:col-span-2">
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                    ...
                    {loading ? <div className="space-y-4">
                        {[...Array(5)].map(
                            (_, index) => <div key={index} className="flex items-start space-x-3 animate-pulse">
                                ...
                                <div className="flex items-center justify-between">
                                    <p className="font-medium text-gray-900 truncate">
                                        ...
                                        <span className="text-sm text-gray-500 whitespace-nowrap ml-2">
                                            {new Date(activity.CreatedOn || activity.createdAt).toLocaleDateString()}
                                        </span>
                                    </p></div>
                                <p className="text-sm text-gray-600 mt-1 line-clamp-2">
                                    {activity.notes}
                                </p>
                                <p className="text-xs text-gray-500 mt-1">by {activity.created_by || activity.createdBy}
                                </p>
                            </div>
                        </motion.div>)}
                    </div>}
            ...
            <div className="space-y-6">
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <Button variant="ghost" size="sm" icon="Plus">Add Task
                                            </Button>
                    </div>
                ...
                <div
                    ...
                    <div className="space-y-3">
                        <Button
                            ...
                            icon="UserPlus">Add New Customer
                                            </Button>
                        <Button
                            variant="secondary"
                            className="w-full justify-start bg-white/20 hover:bg-white/30 text-white border-white/30"
                            icon="Target">Create Lead
                                            </Button>
                        <Button
                            variant="secondary"
                            className="w-full justify-start bg-white/20 hover:bg-white/30 text-white border-white/30"
